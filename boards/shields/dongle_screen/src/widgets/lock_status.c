...
// The ZMK_HID_INDICATOR_* macros are not defined in any header, so we define them here.
// These values correspond to the standard USB HID usage page for LEDs.
#define ZMK_HID_INDICATOR_NUM_LOCK (1 << 0)
#define ZMK_HID_INDICATOR_CAPS_LOCK (1 << 1)
#define ZMK_HID_INDICATOR_SCROLL_LOCK (1 << 2)
